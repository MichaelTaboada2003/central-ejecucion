...
export const api = {
  ...
  getGitHubStatus: async (customToken?: string): Promise<GitHubAccountStatus> => {
    ...
    return {
      authenticated: true,
      username: 'MichaelTaboada2003',
      name: 'Michael Taboada Naranjo',
      avatarUrl: 'https://avatars.githubusercontent.com/u/108304918?v=4',
      totalRepos: 27,
    ...
    return [
      {
        id: 1,
        name: 'music-lab',
        fullName: 'MichaelTaboada2003/music-lab',
        description: 'Audio processing and visualization workspace',
        htmlUrl: 'https://github.com/MichaelTaboada2003/music-lab',
        cloneUrl: 'https://github.com/MichaelTaboada2003/music-lab.git',
        isPrivate: false,
        language: 'Python',
        stars: 4,
        forks: 1,
        ...
        defaultBranch: 'main',
        isCloned: true,
        localProjectId: 'proj-f1d876d7',
        localPath: '/Users/apple/Desktop/Programacion/music-lab',
      },
      {
        id: 2,
        name: 'shalom-app',
        fullName: 'MichaelTaboada2003/shalom-app',
        description: 'Multi-platform church administration application',
        htmlUrl: 'https://github.com/MichaelTaboada2003/shalom-app',
        cloneUrl: 'https://github.com/MichaelTaboada2003/shalom-app.git',
        isPrivate: false,
        language: 'TypeScript',
        stars: 2,
        forks: 0,
      ...
      },
      {
        ...
        fullName: 'MichaelTaboada2003/Portafolio-Astro',
        description: 'Portfolio website built with Astro and Tailwind CSS',
        htmlUrl: 'https://github.com/MichaelTaboada2003/Portafolio-Astro',
        cloneUrl: 'https://github.com/MichaelTaboada2003/Portafolio-Astro.git',
        isPrivate: false,
        language: 'Astro',
        stars: 5,
        forks: 0,
  ...
  cloneGitHubRepo: async (request: CloneRepoRequest): Promise<Project> => {
    ...
    const newProj: Project = {
      ...
      path: `/Users/apple/Desktop/Programacion/${request.repoName}`,
      canonicalPath: `/Users/apple/Desktop/Programacion/${request.repoName}`,
      projectType: 'Web Project',
